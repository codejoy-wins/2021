...
function night(){
    ...
    <video autoplay="autoplay" loop class="vid" controls src="static/img/codejoy-wins.mp4" type="video/mp4"></video>
    `
}
function day(){
    document.getElementById("time").innerHTML=`Good Morning - ${zeus}`;
    document.getElementById("xp").innerHTML=`
    <video autoplay="autoplay" loop class="vid" controls src="static/img/killjoy-wins.mp4" type="video/mp4"></video>
    `
}